...
std::string url = skCrypt("https://keyauth.ru/api/1.2/").decrypt(); // change if you're self-hosting
...
int main()
{
	...
	*/
	...
	/*
	// let's say you want to send request to https://keyauth.ru/api/seller/?sellerkey=f43795eb89d6060b74cdfc56978155ef&type=black&ip=1.1.1.1&hwid=abc
	// but doing that from inside the loader is a bad idea as the link could get leaked.
	// Instead, you should create a webhook with the https://keyauth.ru/api/seller/?sellerkey=f43795eb89d6060b74cdfc56978155ef part as the URL
